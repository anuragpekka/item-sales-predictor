...
#Creates a sample model.yaml file
...
class ModelFactory:
    ...
    #This is only requires to read yaml file, so declared as static
    @staticmethod
    ...
    def execute_grid_search_operation(self, initialized_model: InitializedModelDetail, input_feature,
        ...
        try:
            ...
            # module_name is like sklearn, class_name is like GridSearchCV
