...
from store.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from store.entity.model_factory import evaluate_regression_model


#This class produces the trained model which can be saved as pkl file
