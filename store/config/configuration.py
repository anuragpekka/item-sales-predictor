...
#This class will gather information from config/config.yaml file
class Configuration:
    ...
    # Following "get" functions will return -> a namedtuple from store.entity.config_entity

    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            #START: Gathering info to create named tuple
            ...
            input_data_dir = os.path.join(
                ROOT_DIR,
                data_ingestion_info[DATA_INGESTION_INPUT_DATA_DIR_KEY]
            )
            zip_file_name = data_ingestion_info[DATA_INGESTION_ZIP_FILE_NAME_KEY]
            ...
            #END: Gathering info to create named tuple


            #START: Creating named tuple
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            #Joining the variables to create full directory paths need for traranformation
